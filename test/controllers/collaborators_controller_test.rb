...
class CollaboratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collaborator" do
    assert_difference('Collaborator.count') do
      post collaborators_url, params: { collaborator: { admission_date: @collaborator.admission_date, name: @collaborator.name, resignation_date: @collaborator.resignation_date, sex_id: @collaborator.sex_id } }
    end
  ...
  test "should update collaborator" do
    patch collaborator_url(@collaborator), params: { collaborator: { admission_date: @collaborator.admission_date, name: @collaborator.name, resignation_date: @collaborator.resignation_date, sex_id: @collaborator.sex_id } }
