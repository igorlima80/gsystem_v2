...
class CollaboratorsTest < ApplicationSystemTestCase
  ...
  test "creating a Collaborator" do
    ...
    fill_in "Admission Date", with: @collaborator.admission_date
    fill_in "Name", with: @collaborator.name
    fill_in "Resignation Date", with: @collaborator.resignation_date
    fill_in "Sex", with: @collaborator.sex_id
